...
def extract_cfi_returns(zip_file_name):
    freq_samples = 60

    print('HERE NOOOOOOOW')
...
def parallel_fun(params):
    ...
    path_to_save_all = os.path.join('New_folder')
    ...
    #zip_file_name='AAPL_2019-01-04_24900000_57900000_message_10' # which one should be read as AAPL_2019-01-04_24900000_57900000_message_10
    # LOBSTER data
    lobster_path = 'AAPL_2019-01-04_24900000_57900000_message_10'
    # LOBSTER data for particular ticker for particular year
    ticker_path='AAPL_2019-01-04_24900000_57900000_message_10.csv'


    # make sure that there is LOBSTER data for that year for selected ticker
    #if os.path.exists(ticker_path):
    
    extract_cfi_returns(ticker_path)

    


path_to_save = os.path.join('4_Main_Results_normaliser') 
try:
...
if __name__ == '__main__':   
    ...
    path_tickers = 'snp500_top100_end_2019.csv'
